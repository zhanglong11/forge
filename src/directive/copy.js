/*
 * @Description:点击复制全局指令
 * @Version:
 * @Autor:
 * @Date: 2020-03-12 16:34:00
 * @LastEditTime: 2020-03-13 17:28:15
 */
...
export default {
  bind: (el, binding, vnode) => {
    ...
    const clipboard = new Clipboard(el, {
      text: () => (binding.value.value ? binding.value.value : vnode.data.directives[0].value.copyContent.copyContent)
    })
